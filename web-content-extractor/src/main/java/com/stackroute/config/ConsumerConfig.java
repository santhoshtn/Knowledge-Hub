...
public class ConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, SearchDocument> userConsumerFactory () {
        Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
                new JsonDeserializer<>(SearchDocument.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SearchDocument> userKafkaListenerFactory () {
        ConcurrentKafkaListenerContainerFactory<String, SearchDocument> factory = new ConcurrentKafkaListenerContainerFactory<>();
