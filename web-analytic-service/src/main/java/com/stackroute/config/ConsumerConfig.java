...
public class ConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, WebDocument> userConsumerFactory () {
        Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
                new JsonDeserializer<>(WebDocument.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, WebDocument> userKafkaListenerFactory () {
        ConcurrentKafkaListenerContainerFactory<String, WebDocument> factory = new ConcurrentKafkaListenerContainerFactory<>();
