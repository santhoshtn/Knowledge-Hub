...
public class ConsumerConfig {
    ...
    //Consumer method for SearchJSON object type
    @Bean
    public ConsumerFactory<String, SearchJSON> userConsumerFactory() {
        Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(),
                new JsonDeserializer<>(SearchJSON.class));
    }

    //Kafka listener
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SearchJSON> userKafkaListenerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, SearchJSON> factory = new ConcurrentKafkaListenerContainerFactory<>();
